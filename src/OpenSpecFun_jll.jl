...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import OpenSpecFun_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("efe28fd5-8261-553b-a9e1-b2916fc3738e"))
...
if best_platform === nothing
    @debug("Unable to load OpenSpecFun; unsupported platform $(triplet(platform_key_abi()))")
else
